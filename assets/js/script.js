      ...
      fetch(forecastURL)
        ...
        .then(function (data) {
          ...
          for (var i = 0; i < forecastEls.length; i++) {
            ...
            forecastDate.innerText = moment(forecastIndex.dt * 1000).format(
              "MM/DD/YYYY"
            );
            ...
            forecastWind.innerText =
              "Wind: " + forecastIndex.wind_speed + " MPH";
            forecastHumid.innerText =
              "Humidity: " + forecastIndex.humidity + "%";
            forecastEls[i].append(
              forecastDate,
              forecastIcon,
              forecastTemp,
              forecastWind,
